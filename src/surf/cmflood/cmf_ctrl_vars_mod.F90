...
DO ISEQ=NSEQRIV+1,NSEQALL
  ...
  P2RIVSTO(ISEQ,1)=MIN( P2RIVSTO(ISEQ,1),P2RIVSTOMAX(ISEQ,1)*1._JPRD )
...
ALLOCATE(P2STOOUT(NSEMAX,1))
ALLOCATE(P2RIVINF(NSEMAX,1))
ALLOCATE(P2FLDINF(NSEMAX,1))
ALLOCATE(P2PTHOUT(NSEMAX,1))
