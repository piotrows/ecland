...
! YSURF is no longer allocated inside SUSURF (parent IFS API change synced via PR #44):
! the dummy argument is now TYPE(TSURF),INTENT(INOUT) instead of ALLOCATABLE,INTENT(OUT),
! so the caller is responsible for allocation.
